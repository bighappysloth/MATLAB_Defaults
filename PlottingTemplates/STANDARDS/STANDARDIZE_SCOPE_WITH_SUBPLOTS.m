...
%                 disp("Multiple Tiles Detected");
                ...
                ax.FontSize = PS.Tiled.Global.AxisFontSize;
                ...
                ax.XLabel.FontSize = PS.Tiled.SubPlot.AxisFontSize;
                ax.YLabel.FontSize = PS.Tiled.SubPlot.AxisFontSize;
                ax.ZLabel.FontSize = PS.Tiled.SubPlot.AxisFontSize;
                ...
                ax.Title.FontSize = PS.Tiled.SubPlot.TitleFontSize;
                ax.Title.FontWeight = 'normal';
            else
%                 disp("Single Tile Detected");
                legendobj = findobj(ax, 'Type', 'legend');
                set(legendobj, 'Color',     [1 1 1]);
                set(legendobj, 'TextColor', [0 0 0]);
                set(legendobj, 'FontName', PS.LegendFont);
